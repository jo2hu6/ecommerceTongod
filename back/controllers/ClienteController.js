...
const registro_direccion_cliente = async function(req, res) {
    if (req.user) {
        ...
        if (data.principal) {
            ...
            direcciones.forEach(async d => {
                await Direccion.findByIdAndUpdate({ _id: d._id }, { principal: false });
            });
        }
...
const obtener_detalle_orden_cliente = async function(req, res) {
    if (req.user) {
        var id = req.params['id'];
