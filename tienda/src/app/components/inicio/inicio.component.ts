    ...
    this._clienteService.obtener_config_publico().subscribe(
      response => {
        ...
        response.data.categorias.forEach((element:any) => {
          if(element.titulo == 'Queso'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/quesocat.jpg'
            });
          }else if(element.titulo == 'Manjar Blanco'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/manjarcat.jpg'
            });
          }else if(element.titulo == 'Miel'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/mielcat.jpg'
            });
          }else if(element.titulo == 'Mantequilla'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/mantecat.jpg'
            });
          }else if(element.titulo == 'Yogurt'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/yogurtcat.jpg'
            });
          }else if(element.titulo == 'Rosquitas'){
            this.categorias.push({
              titulo: element.titulo,
              portada: 'assets/img/rosquitacat.jpg'
            });
          }
        });
      }
